...
export const ProjectTask = ({ navigation, route }) => {
	...
	const getMark = (date) => {
		return marks.find((mark) => { return moment(mark).format('YYYY-MM-DD') == date })
	}
	const init = () => {
		getMonthMarkDate()
					...
					<View style={styles.header}>
						<View style={{
							...
							<View>
								<Text
									lineBreakMode='tail'
									style={styles.topTxt}>Hi, {user_Infos.USER_NAME}</Text>
							</View>
						</View>
						<View style={{
							zIndex: 10,
					...
					<View style={styles.body}>
						<View style={styles.bodyTop}>
							...
							<View style={styles.projectImgContainer}>
								<ProjectImage styles={styles.projectImg} source={route.params.PROFILE} />
							</View>
						</View>
										...
										return (
											<TouchableOpacity
												...
												<View style={styles.workerInfo}>
													<Text style={styles.workerName}>{member.USER_NAME}</Text>
										...
										<TouchableOpacity
											...
											<View style={styles.issueInfos}>
												<View style={styles.issueInfo}>
													...
													<View>
														<Text style={styles.issueInfoTxt}>{task.UPLOADERNAME}</Text>
