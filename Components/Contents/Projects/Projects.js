        ...
        <View style={styles.body}>
          ...
          <View style={styles.conetentContainer}>
            ...
            <View style={styles.subtitles}>
              <TouchableOpacity
                style={[styles.subtitleContainer, issueIndex === 0 && styles.issueUnderLine]}
                onPress={() => setIssueIndex(0)}>
                <Text style={[styles.subtitle, issueIndex === 0 && styles.selectedTxt]}>{lanText.info}</Text>
              </TouchableOpacity>
              <TouchableOpacity
                  ...
                  renderItem={({ item, index }) => (
                        <View style={styles.issue}>
                          <View style={styles.issueLeft}>
                            <Feather name="info" size={27} color="#5A3FFF" />
                          ...
                          <Text style={styles.issueTime}>
                            {moment.utc(item.UPLOAD_AT).local().format()}
                          </Text>
                        </View>
                  )}
                  overScrollMode='never'
                ...
                <FlatList
                  ...
                  renderItem={({ item, index }) => (
                    <View style={styles.issue}>
                      ...
                      <Text style={styles.issueTime}>
                        {moment.utc(item.UPLOAD_AT).local().format('YY.MM.DD')}
                      </Text>
                    </View>
                  )}
                  overScrollMode='never'
